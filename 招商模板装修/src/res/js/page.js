...
function page(totalRecord, pageSize,currentpage,url) {
    ...
    if(currentpage<=pageNum) {
        ...
        var nextPage = '<a title="下一页" class="but page" href="'+changeURLPar(url,'page',currentpage+1)+'">下一页</a>';
        var prePage = '<a title="上一页" class="but page" href="'+changeURLPar(url,'page',currentpage-1)+'">上一页</a>';
