...
(function () {
    try{
        ...
        var isCanBuy=ProductUtilService.checkProductBelongCategory(id,"c_50019");
        ...
        var cxt2 = "{skuId:" + skuId + ",factories:[{factory:RPF}]}";
        var priceValueList = ProductService.getPriceValueList(id, userId, "head_merchant", 1, cxt2, "normalPricePolicy");
        if(priceValueList[0] && priceValueList[0].formatUnitPrice){
            productJso.memberPrice = "¥" + priceValueList[0].formatUnitPrice;
        }else{
            productJso.memberPrice = "暂无价格";
        }
